...
/**
 * Verified against Google Slides 1.26.341.01.90 (versionCode 220702177),
 ...
 *     (same shared launcher architecture as Docs and Sheets).
 *   - ProxyLaunchActivity exists in classes2.dex and directly defines a
 ...
 *     the GooglePlayUtility strings are present in classes3.dex.
 */
internal object Constants {
    const val GSLIDES_PACKAGE_NAME = "com.google.android.apps.docs.editors.slides"
    const val MORPHE_GSLIDES_PACKAGE_NAME = "app.morphe.android.apps.docs.editors.slides"
    ...
    const val GSLIDES_MAIN_ACTIVITY_CLASS_TYPE =
    ...
    const val GSLIDES_SPOOFED_PACKAGE_SIGNATURE =
