...
import app.morphe.patches.gslides.misc.gms.Constants.GSLIDES_MAIN_ACTIVITY_CLASS_TYPE

/**
 * VERIFIED against Slides 1.26.341.01.90: targets ProxyLaunchActivity (the
 ...
 * Matches the onCreate(Bundle) method of Google Slides's main/launcher Activity.
 ...
 * fingerprints, but Google Slides may. Only add them if you observe the app
...
internal object HomeActivityOnCreateFingerprint : Fingerprint(
    definingClass = GSLIDES_MAIN_ACTIVITY_CLASS_TYPE,
    name = "onCreate",
    returnType = "V",
